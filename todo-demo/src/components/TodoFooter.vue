    ...
    <ul class="filters">
      <li>
        <!-- 6.1 判断谁应该有高亮样式: 动态class
         ...
         -->
        <a :class="{selected: isSel === 'all'}" href="javascript:;" @click="fn('all')">全部</a>
      </li>
      <li>
        <a :class="{selected: isSel === 'no'}" href="javascript:;" @click="fn('no')">未完成</a>
      </li>
      <li>
        <a :class="{selected: isSel === 'yes'}" href="javascript:;" @click="fn('yes')">已完成</a>
      </li>
    </ul>
    <!-- 7. 目标: 清除已完成 -->
    <!-- 7.0 点击事件 -->
